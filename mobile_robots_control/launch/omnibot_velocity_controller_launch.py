...
robot_model = 'omnibot'
robot_base_color = 'White' #Gazebo color of the robot's main body
...
def generate_launch_description():
    ...
    #Robot params from yaml file
    robot_params_path =  os.path.join( pkg_robot_simulation, "config", 'omnibot_params.yaml', )
    
    robot_description = {"robot_description": xacro.process_file(robot_description_path, 
        mappings={
            'base_color' : robot_base_color,
            'params_path' : robot_params_path
            }).toxml()}
